...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_xN] = { // Numbers
    {KC_ESC,  _______, _______, _______, KC_NLCK, KC_PSLS, KC_7,    KC_8,    KC_9,    KC_0},
    {KC_TAB,  _______, _______, _______, _______, KC_PAST, KC_4,    KC_5,    KC_6,    KC_PPLS},
    {_______, _______, _______, _______, _______, KC_PMNS, KC_1,    KC_2,    KC_3,    KC_PEQL},
    {XXXXXXX, _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX},
...
void matrix_scan_user(void) {
  //
  // Bit #           7     6     5     4     3     2     1     0
  // layer_state: [     |     |     | _xF | _xN | _xS | _xW | _xQ ]
  // usb_led      [     |     |     |kana |cmps |scrl | num |caps ]
  // PORTB:       [  NC |  10 |   9 |   8 |  14 |  16 |rxled|  15 ]
  // PORTC:       [  NC |   5 |     |     |     |     |     |     ]
  // PORTD:       [   6 |  NC |txled|   4 | tx* | rx* | p29 | grn ]
  // PORTE:       [     |   7 |     |     |     |     |     |     ]
