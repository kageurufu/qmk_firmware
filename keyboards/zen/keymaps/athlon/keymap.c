...
[_QWERTY] = KEYMAP( \
  ...
  KC_LCTL,  KC_RALT, KC_LALT, RGB_TOG, MO(_NAV), KC_SPC,  KC_DEL,  KC_ENT,   KC_SPACE, MO(_NAV), KC_MINS, KC_EQL,  KC_PGUP, KC_PGDN \
),
...
[_NAV] = KEYMAP( \
  ...
  _______, RGB_SAI, KC_UP,   RGB_SAD,  RESET,   KC_LBRC,                   KC_RBRC,           KC_PGUP,  KC_UP,   KC_PGDN, KC_INS,  KC_HOME , \
  _______, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______,                   _______,           KC_LEFT,  KC_DOWN, KC_RGHT, KC_DEL,  KC_END , \
  KC_LSFT, RGB_VAI, RGB_HUD, RGB_VAD,  RGB_HUI, _______,                   MAGIC_TOGGLE_NKRO, _______,  _______, KC_MPLY, KC_MPRV, KC_MNXT , \
